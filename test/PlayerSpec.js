...
describe('Player', () => {
  ...
  describe('splitHand()', () => {
    ...
    verify.it('should be able to split multiple times', Gen.integerBetween(1,11), (value) => {
      ...
      bob.receiveCard(deck.dealCard())
      bob.receiveCard(deck.dealCard())
      console.log('dealt 2 cards', bob.showHand())
      console.log('hands before split', bob.hands)
      bob.splitHand(1)
      console.log('hands after split', bob.hands)
      console.log('hand 1', bob.showHand(1))
      console.log('hand 2', bob.showHand(2))
      bob.receiveCard(deck.dealCard(),1)
      bob.receiveCard(deck.dealCard(),2)
      console.log('hands after deal to split hands', bob.hands)
      console.log('hand 1', bob.showHand(1))
      console.log('hand 2', bob.showHand(2))
      bob.splitHand(2)
      console.log('hands after second split', bob.hands)
      console.log('hand 1', bob.showHand(1))
      console.log('hand 2', bob.showHand(2))
      // console.log('hand 3', bob.showHand(3))
    })
